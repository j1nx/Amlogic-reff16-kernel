...
static unsigned int FN_KEY_SCANCODE = -1;  // 0; 
static unsigned int LEFT_KEY_SCANCODE = -1;  // 0;
static unsigned int RIGHT_KEY_SCANCODE = -1;  // 0;
static unsigned int UP_KEY_SCANCODE = -1;  // 0;
static unsigned int DOWN_KEY_SCANCODE = -1;  // 0;
static unsigned int OK_KEY_SCANCODE = -1;  // 0;
static unsigned int PAGEUP_KEY_SCANCODE = -1;  // 0;
static unsigned int PAGEDOWN_KEY_SCANCODE = -1;  // 0;
